...
import (
	...
	"github.com/hoaleee/zkevm-node/test/contracts/bin/BridgeA"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/BridgeB"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/BridgeC"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/BridgeD"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/Called"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/Caller"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/ChainCallLevel1"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/ChainCallLevel2"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/ChainCallLevel3"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/ChainCallLevel4"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/Counter"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/Creates"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/Depth"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/ERC20"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/EmitLog"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/Memory"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/OpCallAux"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/Revert2"
