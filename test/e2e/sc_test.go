...
import (
	...
	"github.com/hoaleee/zkevm-node/test/contracts/bin/EmitLog2"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/FailureTest"
	"github.com/hoaleee/zkevm-node/test/contracts/bin/Read"
